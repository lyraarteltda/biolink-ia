...
const KillSwitch = (function() {
  ...
  function showMaintenancePage() {
    ...
    overlay.style.cssText = 'position:fixed;inset:0;z-index:99999;display:flex;align-items:center;justify-content:center;background:#0d0b12;';
    overlay.innerHTML = '<div style="text-align:center;max-width:480px;padding:32px;">' +
      '<div style="font-size:48px;margin-bottom:24px;">🔧</div>' +
      '<h1 style="font-size:28px;font-weight:800;margin-bottom:16px;background:linear-gradient(135deg,#fff,#ffcf6b);-webkit-background-clip:text;-webkit-text-fill-color:transparent;">Em Manutenção</h1>' +
      ...
      '<div style="display:inline-block;background:rgba(255,207,107,.12);color:#ffcf6b;padding:8px 20px;border-radius:100px;font-size:13px;font-weight:600;border:1px solid rgba(255,207,107,.25);">Maestros da IA</div>' +
      '</div>';
